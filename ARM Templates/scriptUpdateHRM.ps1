...
$VHDStorageAccountURI = "https://saplrshrmweuprdrds01.blob.core.windows.net/system/Microsoft.Compute/Images/template/rhtplv2_09042020_v01-osDisk.24cf7e31-f94a-477e-96af-e58688ae3f3d.vhd"
,
  [string]$RDSHostname= "vmhrmweuprdrh88"
)
#########################
#### Begin of RDSH 01 ###
#########################
